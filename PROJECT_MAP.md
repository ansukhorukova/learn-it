...
Останнє оновлення: 2026-08-24 — board/task description-поля виведено у FE (форми створення/перейменування борду, картка борду, форма створення таски, нова секція опису в TaskPanel) поверх уже наявних колонок `boards.description`/`tasks.notes`; статуси вузлів без змін.
