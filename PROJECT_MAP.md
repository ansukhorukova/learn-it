...
Останнє оновлення: 2026-08-24 — фіча "Board & Task Sharing" (US13-US17: шеринг борду й окремої таски, ролі viewer/collaborator) заапрувена після двох раундів review; `BE_BoardMembers`, `DB_BoardMembers`, `BE_TaskShares`, `DB_TaskShares`, `DB_AttachmentViewers` позначено `done`, доданий новий вузол `FE_SharePanel`.
...
graph TD
  ...
  class DB_Users,DB_Tasks,DB_Boards,DB_Attachments,DB_TimeEntries,DB_BoardMembers,DB_TaskShares,DB_AttachmentViewers done;
```
